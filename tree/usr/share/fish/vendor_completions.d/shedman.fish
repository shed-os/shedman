...
for sub in apply update doctor rollback uninstall dock kernel fingerprint theme snapshot updates conflicts health lock config db install services status logs upgrade-history
